...
namespace SpaceWarProject
{
    public class Game
    {
        ...
        private const double powerup_interval = 15.0;
        private double obstacleSpawnTimer = obstacle_spawn_interval;
        private double powerUpSpawnTimer = powerup_interval;
        ...
        private bool CheckCollision(Object obj1, Object obj2)
        {
        ...
        private void SaveScore()
        {
            try
            {
                ...
                {
                    highScore = score;
                    File.WriteAllText(file, highScore.ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        private void LoadHighScore()
        {
            try
            {
                if (File.Exists(file))
                {
                    string scoreText = File.ReadAllText(file);
